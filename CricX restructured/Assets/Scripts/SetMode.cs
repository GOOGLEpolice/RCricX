...
public class SetMode : MonoBehaviour
{
    public void CalculateSetScore()
    {
        ...
        if (GameManager.instance.playerRuns < 0 && GameManager.instance.typeOfOpponent == "Batsman")
        {
            ...
            {
                GameManager.instance.opponentCardStats.gameObject.transform.DOScale(Vector3.zero, 0.5f).OnComplete(() => { GameManager.instance.playerCardSelected = false; Destroy(GameManager.instance.opponentCardStats.gameObject); });
